...
generate_configFileParameters = ConfigFileParameters(
    ...
    releaseRefName = 'CMSSW_12_0_0_pre3',
    releaseTestName = 'CMSSW_12_0_0_pre3',
    workingRefDir = 'CMSSW_12_0_0_pre3_HGCalTPGValidation_ref',
    workingTestDir = 'CMSSW_12_0_0_pre3_HGCalTPGValidation_test',
    remoteRefBranchName = 'hgc-tpg-devel-CMSSW_12_0_0_pre3',
    remoteTestBranchName = 'hgc-tpg-devel-CMSSW_12_0_0_pre3',
    localRefBranchName = 'local_hgc-tpg-devel-CMSSW_12_0_0_pre3',
    localTestBranchName = 'local_hgc-tpg-devel-CMSSW_12_0_0_pre3',
    remoteRef = 'PFCal-dev',
